...
use Drupal\sync\Plugin\SyncResourceFileBase;
use Drupal\sync\SyncFailException;

/**
 * Plugin implementation of the 'remote_image_file' eXo theme.
 *
 ...
 * )
 */
class RemoteImageAsFile extends SyncResourceFileBase {
